...
public class Repository<T> : IRepository<T> where T : class
{
    ...
    public Repository(ApplicationDbContext db = null, MasterDbContext mdb = null)
    {
        _context = (DbContext)db ?? (DbContext)mdb;

        if (_context == null)
        {
            throw new ArgumentException("At least one DbContext must be provided");
        }
